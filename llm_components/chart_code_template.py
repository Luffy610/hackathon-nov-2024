...
class ChartTemplate:
    ...
    def get_template(self, goal: Goal, library: str):
        general_instructions = f"""If the solution requires a single value 
        (e.g. max, min, median, first, last etc), 
        ...
        Given the dataset summary, the plot(data) method should generate a {library} 
        chart ({goal.visualization}) that addresses this goal: {goal.question}. 
        DO NOT WRITE ANY CODE TO LOAD THE DATA. 
